...
function patchRegex(path, regex, after, label) {
  let source = readFileSync(path, "utf8");
  if (!regex.test(source)) throw new Error(`Expected ${label} pattern missing in ${path}`);
